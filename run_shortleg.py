...
from reflex_opt.run_policy_consective_shortleg import run_policy_consective_shortleg


folder_name1 = 'review_back_shortleg_1'
folder_name2 = 'review_forw_shortleg_1'
...
if __name__ == '__main__':
    ...
    run_policy_consective_shortleg(env=VPenv, ws_dataset=ws_dataset)