...
from reflex_opt.run_policy_consective_timedelay import run_policy_consective_timedelay

folder_name1 = 'review_back_timedelay_1'
folder_name2 = 'review_forw_timedelay_1'
...
if __name__ == '__main__':
    ...
    run_policy_consective_timedelay(env=VPenv, ws_dataset=ws_dataset)